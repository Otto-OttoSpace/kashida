...
function fetchText(url, { binary = false, timeout = 20000 } = {}) {
  return new Promise((resolve, reject) => {
    ...
    const req = lib.get(url, { headers: { 'User-Agent': 'kashida/0.3 (+https://kashida.ottospace.co)' } }, (res) => {
...
module.exports = { isAvailable, run, curlAnalyze, fetchText, decodeEntities, familyIsLatinOnly };
